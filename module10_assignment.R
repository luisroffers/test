...
getwd()
setwd("/Users/luisrosales/Documents/Module10")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      selectInput(inputId = "subset_income", label="Income",choices = unique(income$income)),
      # Interactive piece 2: inputId = "set_yaxis"
      selectInput(inputId = "set_yaxis", label="Choose Category", 
